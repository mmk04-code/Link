...
class Project(models.Model):
    ...
    bid_type = models.CharField(max_length=20, choices=BID_TYPE_CHOICES, default='flexible')
    budget_min = models.DecimalField(max_digits=10, decimal_places=2)
    budget_max = models.DecimalField(max_digits=10, decimal_places=2)
    duration_days = models.IntegerField(help_text="Expected duration in days")
    deadline_type = models.CharField(max_length=20, choices=DEADLINE_TYPE_CHOICES, default='flexible')
    submission_deadline = models.DateField(null=True, blank=True)
    max_proposals = models.PositiveIntegerField(default=50)
